...
class CompanyController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $company->english_name = $request->english_name;
        $company->about_arabic = $request->about_arabic;
        $company->about_english = $request->about_english;
        $company->address_arabic = $request->address_arabic;
        $company->address_english = $request->address_english;
        $company->inforation = $request->inforation;
        ...
        if ($request->avatar) {
            ...
            Storage::disk('local')->put('public/companies' . '/' . $fileName, $img, 'public');
            $avatarImageName = 'companies/'  . $fileName;
            // file_put_contents(public_path() . '/storage/companies/' . $avatarImageName, $img);
            $company->avatar = $avatarImageName;
        }
        $update = $company->save();
