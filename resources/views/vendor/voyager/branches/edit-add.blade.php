                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" id="validationCustom01"
                                ...
                                value="{{ $edit ? \App\Models\Branch::find($dataTypeContent->getKey())->name : '' }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="english_name" class="form-control" id="validationCustom01"
                                placeholder="الإسم بالإنجليزي" required
                                value="{{ $edit ? \App\Models\Branch::find($dataTypeContent->getKey())->english_name : '' }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="phone_number" class="form-control" id="validationCustom01"
                                placeholder="رقم الهاتف"
                                value="{{ $edit ? \App\Models\Branch::find($dataTypeContent->getKey())->phone_number : '' }}">
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom01">
                                الفاكس
                            ...
                            <input type="text" name="fax" class="form-control" id="validationCustom01"
                                placeholder="الفاكس"
                                value="{{ $edit ? \App\Models\Branch::find($dataTypeContent->getKey())->fax : '' }}">
                        </div>
